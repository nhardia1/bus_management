 ...
 <div class="modal fade booking" id="bus_<?php echo $busid;?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-dialog" style="width:750px;">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a class="btn btn-default pull-left" href="javascript:void(0)" data-dismiss="modal" aria-hidden="true" id="cancel_booking" onclick="cancelTicket(<?php echo $busid;?>);">Cancel</a>
 ...
 var center = new google.maps.LatLng(20.5937,78.9629);  
  ...
  ?>
   ...
   var directionsService = new google.maps.DirectionsService();
    ...
    var colourArray = ['navy', 'red', 'fuchsia', 'black', 'lime', 'maroon', 'purple', 'aqua', 'red', 'green', 'silver', 'olive', 'blue', 'yellow', 'teal'];
