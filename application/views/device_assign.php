  ...
  <div class="row ui-section">
    ...
    <div class="col-md-12 breadcum_container">
            <section class="panel panel-default breadcum_section">
              ...
              <h3 class="section-header"><?php echo $this->lang->line("device")." ".$this->lang->line("assign")." ".$this->lang->line("management");?></h3>
    ...
    <div class="col-md-12">
      <section class="panel panel-default table-dynamic">
        <div class="add_btn">
              <a type=button style="float: right;" href="<?php echo base_url();?>index.php/device_assign/add" class="md-fab blue_bg md-button md-default-theme"  aria-label="" data-toggle="tooltip" title="<?php echo $this->lang->line("bus_assign_device_to_bus"); ?>"><span class="imd imd-add"></span></a>
        </div>
    ...
    <div class="ui-tab-container ui-tab-horizontal">
      <div justified="false" class="ui-tab ng-isolate-scope">               
        ...
        <div class="tab-content">
          ...
          <div id="contenttab2" class="tab-pane active"><?php echo $this->table->generate(); ?></div>
