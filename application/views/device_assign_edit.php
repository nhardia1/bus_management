            ...
            <div class="col-md-12">
              <form name="device_assign_form" id="device_assign_form" method='post' data-parsley-validate>
                      ...
                      <?php
                        ...
                        foreach ($all_device as $key => $device) 
                        {
                            if($device_id == $device->id)
                              echo "<option value=".$device->id." selected='selected'>".$device->name."</option>";
                            else
                ...
                <div class="card-action no-border col-md-12" align="right">
                  ...
                  <input id="submit" type="button" value="Update" ui-wave class="btn btn-primary md-button" />
...
$('#submit').click(function()
{
      ...
      if(bus_name!="" && bus_device!="" && assign_date!="")
      {
          ...
          $.ajax({
            method:'POST',
            url:BASE_PATH_URL+"index.php/device_assign/update",
            data:post_data,
